...
router.get("/", function(req, res){
    ...
    University.find({}, function(err, allUniversities){
        if(err){
            ...
            res.render("universities/index", {universities: allUniversities, currentUser: req.user, page: 'universities'});
        }
    });
});
...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    geocoder.geocode(req.body.location, function (err, data) {
        ...
        var newUniversity = {name: name, tuition: tuition, image: image, description: desc, author: author, location: location, lat: lat, lng: lng}
...
router.put("/:id", middleware.checkUniversityOwnership, function(req, res){
    geocoder.geocode(req.body.location, function (err, data) {
        ...
        University.findByIdAndUpdate(req.params.id, req.body.university, function(err, updatedUniversity){
            if(err){
